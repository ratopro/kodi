...
def seriesblanco0(params):
    plugintools.log("[PalcoTV-0.3.0].seriesblanco "+repr(params))
...
def seriesblanco1(params):
    plugintools.log("[PalcoTV-0.3.0] SeriesBlanco1 "+repr(params))
...
def gethttp_referer_headers(url,referer,show):
    plugintools.log("PalcoTV-0.3.0.gethttp_referer_headers ")
